...
#using parameters
#def greet(first_name, last_name): #these are parameters an input you put to define your function
   #print(f"Hi {first_name} {last_name}")
   #print("hello")
   #print ("welcome aboard")
   
   
#greet("Agatha" "Anyango")# this is an argument  an actual value for a given parameter
